...
window.onload = function() {
  ...
  buttons.forEach(function(button) {
    button.addEventListener('click', function() {
      ...
      switch (this.id) {
        case 'file-button':
          src = '<?php echo getenv('BASE_URL'); ?>/002.php?parent_id=' + '<?php echo $parent_id; ?>&token=<?php echo $token; ?>';
          break;
        case 'user-button':
          src = '<?php echo getenv('BASE_URL'); ?>/iymm.php?parent_id=' + '<?php echo $parent_id; ?>&token=<?php echo $token; ?>';
          break;
        case 'number-button':
          src = '<?php echo getenv('BASE_URL'); ?>/qlru002.php?parent_id=' + '<?php echo $parent_id; ?>&token=<?php echo $token; ?>';
          break;
        case 'order-button':
          src = '<?php echo getenv('BASE_URL'); ?>/数据.php?parent_id=' + '<?php echo $parent_id; ?>&token=<?php echo $token; ?>';
          break;
        case 'load-data':
          src = '<?php echo getenv('BASE_URL'); ?>/003.php?parent_id=' + '<?php echo $parent_id; ?>&token=<?php echo $token; ?>';
          break;
        case 'data-button':
          src = '<?php echo getenv('BASE_URL'); ?>/qlru.php?token=<?php echo $token; ?>';
          break;
        case 'kami-button':
          src = '<?php echo getenv('BASE_URL'); ?>/qlrurjbc.php?token=<?php echo $token; ?>';
          break;
        case 'website-button':
          src = '<?php echo getenv('BASE_URL'); ?>/qlru001.php?token=<?php echo $token; ?>';
          break;
        case 'gold-limit-button':
          src = '<?php echo getenv('BASE_URL'); ?>/qlru003.php?token=<?php echo $token; ?>';
          break;
        case 'key-button':
          src = '<?php echo getenv('BASE_URL'); ?>/qlrupnqe.php?token=<?php echo $token; ?>';
          break;
        case 'channel-button':
          src = '<?php echo getenv('BASE_URL'); ?>/qlruceut.php?token=<?php echo $token; ?>';
          break;
      }
      dataIframe.src = src;
      dataIframe.style.display = 'block';
  ...
  if (fileButton) {
    fileButton.addEventListener('click', function() {
      var src = '<?php echo getenv('BASE_URL'); ?>/002.php?token=<?php echo $token; ?>';
      dataIframe.src = src;
      dataIframe.style.display = 'block';
  ...
  numberButton.addEventListener('click', function() {
    var src = '<?php echo getenv('BASE_URL'); ?>/qlru002.php?token=<?php echo $token; ?>';
    dataIframe.src = src;
    dataIframe.style.display = 'block';
    localStorage.setItem('iframeSrc', src); // 保存URL到localStorage
  });
  ...
  if (userButton) {
    userButton.addEventListener('click', function() {
      var src = '<?php echo getenv('BASE_URL'); ?>/iymm.php?token=<?php echo $token; ?>';
      dataIframe.src = src;
      dataIframe.style.display = 'block';
      localStorage.setItem('iframeSrc', src); // 保存URL到localStorage
    });
  ...
  goldLimitButton.addEventListener('click', function() {
    var src = '<?php echo getenv('BASE_URL'); ?>/qlru003.php?token=<?php echo $token; ?>';
    dataIframe.src = src;
    dataIframe.style.display = 'block';
    localStorage.setItem('iframeSrc', src); // 保存URL到localStorage
  });
  ...
  keyButton.addEventListener('click', function() {
    var src = '<?php echo getenv('BASE_URL'); ?>/qlrupnqe.php?token=<?php echo $token; ?>';
    dataIframe.src = src;
    dataIframe.style.display = 'block';
    localStorage.setItem('iframeSrc', src); // 保存URL到localStorage
  });
  ...
  channelButton.addEventListener('click', function() {
    var src = '<?php echo getenv('BASE_URL'); ?>/qlruceut.php?token=<?php echo $token; ?>';
    dataIframe.src = src;
    dataIframe.style.display = 'block';
    localStorage.setItem('iframeSrc', src); // 保存URL到localStorage
  });
...
loadDataButton.addEventListener('click', function() {
  var src = '<?php echo getenv('BASE_URL'); ?>/003.php?token=<?php echo $token; ?>';
  dataIframe.src = src;
  dataIframe.style.display = 'block';
  localStorage.setItem('iframeSrc', src);
});
...
orderButton.addEventListener('click', function() {
  var src = '<?php echo getenv('BASE_URL'); ?>/数据.php?token=<?php echo $token; ?>';
  dataIframe.src = src;
  dataIframe.style.display = 'block';
  localStorage.setItem('iframeSrc', src);
});
